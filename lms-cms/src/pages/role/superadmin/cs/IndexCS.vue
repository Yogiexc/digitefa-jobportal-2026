...
const goAddBatch = (id) => {
    router.push(`/course-manajemen/batch/${id}`);
};

const showDetailPage = (item) => {
    currentCourse.value = item;
    router.push(`/course-manajemen/detail/${currentCourse.value.id_course}`);
};
                        ...
                        <div class="col-md-12 mt-4 mt-md-0">
                            <div class="cbg-card rounded-2 p-4 border-0 cs">
                                ...
                                <div class="d-flex justify-content-between mb-3 mt-4">
                                    ...
                                    <ButtonBiru class="fs-16 px-3 rounded-3 h-40" @click="openModal">Add
                                        Course
                                    </ButtonBiru>
                                </div>
                                <CourseModal :showModal="showModal" @close="showModal = false" />
                                <div class="col-md-12 mt-4 mt-md-0">
                                        ...
                                        <table class="table custom-table rounded-4">
                                            ...
                                            <tbody class="table-custom">
                                                <tr v-for="(item, index) in paginatedData" :key="item.id">
                                                    <td class="ps-4" style="padding-top: 33px;">{{ (currentPage - 1) *
                                                        itemsPerPage + index + 1 }}
                                                    </td>
                                                    <td>
                                                        <div class="d-flex justify-content-start align-items-center hover-background"
                                                            ...
                                                            <ul v-if="dropdownVisible"
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item fw-normal fs-16 pointer"
                                                                        ...
                                                                        <i
                                                                            class="bi bi-file-earmark-plus me-1 fs-16"></i>
                                                                        Batch
                                                                    </a>
                                                                </li>
                                                                <li>
