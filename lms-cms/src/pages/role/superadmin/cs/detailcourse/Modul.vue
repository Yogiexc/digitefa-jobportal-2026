...
const showAddVideoPage = () => {
    if (selectedModule.value) {
        ...
        router.push(`/course-manajemen/modul/${courseId}/add-video/${id_course_section}`);
    }
};
const showAddQuizPage = () => {
    if (selectedModule.value) {
        const id_course_section = selectedModule.value.id_course_section;
        router.push(`/course-manajemen/modul/${courseId}/add-quiz/${id_course_section}`);
    }
};
const showAddAssignmentPage = () => {
    if (selectedModule.value) {
        const id_course_section = selectedModule.value.id_course_section;
        router.push(`/course-manajemen/modul/${courseId}/add-assignment/${id_course_section}`);
    }
};
const showEditVideoPage = (material) => {
    if (material) {
        ...
        router.push(`/course-manajemen/modul/${courseId}/edit-video/${id_course_material}/${id_course_section}`);
    }
};
const showEditAssignmentPage = (assignment) => {
    if (assignment) {
        ...
        router.push(`/course-manajemen/modul/${courseId}/edit-assignment/${id_course_assignment}/${id_course_section}`);
    }
};
const showEditQuizPage = (quiz) => {
    if (quiz) {
        ...
        router.push(`/course-manajemen/modul/${courseId}/edit-quiz/${id_quiz}/${id_course_section}`);
    }
};
                    ...
                    <div class="col-md-12 mt-4 mt-md-0">
                        <div class="cbg-card p-4 border-0">
                            ...
                            <div class="cbg-card2 p-3 bordersa mt-2 min-height-68 modul">
                                <NavCourse />
                                <div v-for="item in modules" :key="item.id" class="mdl">
                                    <div
                                    ...
                                    <div v-if="item.showButtons" :data-module-id="item.id_course_section"
                                        ...
                                        <ButtonBiru @click="showAddVideoPage" class="fs-16">+ Tambah Materi</ButtonBiru>
                                        <ButtonBiru @click="showAddQuizPage" class="fs-16">+ Tambah Quiz</ButtonBiru>
                                        <ButtonBiru @click="showAddAssignmentPage" class="fs-16">+ Tambah Assignment</ButtonBiru>
                                    </div>
                                </div>
                                <button
