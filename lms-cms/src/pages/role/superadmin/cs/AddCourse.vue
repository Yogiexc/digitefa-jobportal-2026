...
const submitCourse = async () => {
    ...
    try {
        ...
        setTimeout(() => {
            router.push(`/course-manajemen/detail/${newCourseId}`);
        }, 800);
    } catch (error) {
...
onMounted(() => {
    ...
    if (storedTeacher) {
        ...
        teacherId.value = teacherData.teacherid;
    }
    checkWindowSize();
                        ...
                        <div class="col-md-12 add">
                            <div class="card rounded-2 p-4 border-0 mt-4 mt-md-0">
                                ...
                                <div class="card p-3 bordersa mt-4">
                                    ...
                                    <hr />
                                    <div class="mb-3 row">
                                        <label for="teacherName" class="col-sm-3 col-form-label fs-16">Teacher</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="number" 
                                                ...
                                                placeholder="Enter Durasi Course" 
                                                v-model="form.duration" 
                                                required />
                                            <span class="input-group-text fs-16">Day</span>
                                        </div>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
