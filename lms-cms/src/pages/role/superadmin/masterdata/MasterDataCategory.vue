...
const loadFromLocalStorage = () => {
    ...
    if (storedData) {
        categoryData.value = JSON.parse(storedData);
    }
};
...
const fetchCategoryData = async () => {
    try {
        ...
        saveToLocalStorage(categoryData.value);
    } catch (error) {
...
const submitForm = async () => {
    ...
    try {
        ...
        showToast('Error Add Category.', 'error');
    } finally {
...
const showEditCategoryModal = () => {
    form.value.name = currentCategory.value.name;
    hideDropdownMenu();
...
const deleteCategory = async () => {
    ...
    try {
        if (currentCategory.value) {
            await axios.delete(`/categories/${currentCategory.value.id_category}`);
            fetchCategoryData();
            closeModal();
        ...
        <div class="navbg-sa">
            ...
            <div id="contentsa" class="dashboard-sa">
                <div class="container mt-80">
                    <div class="row">
                        <div class="col-md-12 mt-4 mt-md-0">
                            <div class="cbg-card rounded-3 p-4 border-0">
                                <h5 class="fw-light fs-16">Digitefa/Master Data/Category</h5>
                                <h4 class="fs-24">Category</h4>
                                ...
                                <div class="d-flex justify-content-between mb-3 mt-4">
                                    ...
                                    <ButtonBiru class="fs-16 px-3 rounded-3 h-40" @click="showAddCategoryModal">Add
                                        Category
                                    </ButtonBiru>
                                </div>
                    ...
                    <!-- Edit Modal -->
                    <div v-if="isEditModalVisible" class="modal-backdrop" @click="closeEditCategoryModal">
                    </div>
                        ...
                        <div class="modal-dialog custom-modal modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="d-flex justify-content-center mb-5">
                                    <ButtonTransparanComponen
                                        class="mt-4 my-0 h-40 w-30 me-5 rounded-3 c-border bg-white fs-16"
                                        @click="closeEditCategoryModal">Cancel
                                    </ButtonTransparanComponen>
                                    <ButtonBiru class="ms-3 mt-4 my-0 h-40 w-30 rounded-3 fs-16" @click="saveCategory">
                                        Save
                                    </ButtonBiru>
                                </div>
                            </div>
                    ...
                    <div v-if="isDeleteModalVisible" class="modal fade show d-block" role="dialog"
                        aria-labelledby="deleteModalLabel" aria-hidden="true" @click.self="closeDeleteCategoryModal">
                        <div class="modal-dialog custom-modal modal-dialog-centered">
                            <div class="modal-content pt-3">
                                <div
                                    ...
                                    <h5 class="mb-4 mt-3 fs-16 fw-medium text-merah">Delete Category
                                    </h5>
                                ...
                                <div class="d-flex justify-content-center mb-5">
                                    <ButtonTransparanComponen
                                        ...
                                        @click="closeDeleteCategoryModal">No, Cancel
                                    </ButtonTransparanComponen>
                                    <ButtonMerah class="ms-3 my-0 h-40 w-30 rounded-3 fs-16" @click="deleteCategory">
                                        Yes,
                                        Delete</ButtonMerah>
                                </div>
                            </div>
