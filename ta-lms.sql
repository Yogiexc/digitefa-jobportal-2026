...
CREATE TABLE `assignment_submissions` (
  `id_assignment_submission` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_course_enrollment` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_course_assignment` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `assignment_submission_resources` (
  ...
  `id_assignment_submission` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `courses` (
  `id_course` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_category` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_teacher` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_course_level` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `course_assignments` (
  `id_course_assignment` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_course_section` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` longtext COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `course_assignment_resources` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_course_assignment` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fileid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `course_assignment_skills` (
  `id_course_assignment` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_skill` char(36) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `course_batches` (
  `id_course_batch` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_course` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `course_enrollments` (
  `id_course_enrollment` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_course_batch` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_student` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `start_date` date DEFAULT NULL,
  `end_date` date DEFAULT NULL,
  `status` enum('enrolled','completed','failed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'enrolled',
...
CREATE TABLE `course_materials` (
  `id_course_material` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_course_section` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` longtext COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `course_material_resources` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_course_material` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fileid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `course_reviews` (
  `id_course_review` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_student` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_course` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rating` int NOT NULL,
...
CREATE TABLE `course_rules` (
  `id_course_rule` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_course` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `course_tools` (
  `id_course` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_tool` char(36) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `faqs` (
  `id_faq` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `media_partners` (
  `id_media_partner` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `point_histories` (
  `id_point_history` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_student` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_course_enrollment` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_skill` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `source_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `source_type` enum('course_material','course_assignment','quiz','course_completion','skill_point','assignment_submission','quiz_submission') COLLATE utf8mb4_unicode_ci NOT NULL,
  `point` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `questions` (
  `id_question` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `quizzes` (
  `id_quiz` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_course_section` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` longtext COLLATE utf8mb4_unicode_ci,
  `duration` int NOT NULL,
...
CREATE TABLE `quiz_options` (
  `id_quiz_option` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_quiz_question` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `answer` longtext COLLATE utf8mb4_unicode_ci,
  `reference_answer` longtext COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `quiz_option_resources` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_quiz_option` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fileid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `quiz_questions` (
  `id_quiz_question` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_quiz` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('single_choice','multiple_choice','essay') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `quiz_question_resources` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_quiz_question` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fileid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `quiz_resources` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_quiz` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fileid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `quiz_submissions` (
  `id_quiz_submission` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_course_enrollment` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_quiz` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `quiz_submission_answers` (
  `id_quiz_submission_answer` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_quiz_submission` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_quiz_question` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_quiz_option` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `answer` longtext COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `social_links` (
  `id_social_link` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_teacher` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `student_certificates` (
  `id_student_certificate` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_course_enrollment` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `student_progress` (
  `id_student_progress` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_course_enrollment` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_course_material` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `student_skill_points` (
  `id_student_skill_point` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_student` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_skill` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `teachers` (
  ...
  `status` enum('not_submitted','submitted','approved','rejected') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_submitted',
...
CREATE TABLE `teachers_certificates` (
  `id_teacher_certificate` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_teacher` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `teacher_reviews` (
  `id_teacher_review` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_student` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_teacher` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rating` int NOT NULL,
  `content` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `teacher_update_categories` (
  `id_teacher_update_request` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_category` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `teacher_update_certificates` (
  `id_request_certificate` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_teacher_update_request` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `file` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `teacher_update_requests` (
  `id_teacher_update_request` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('profile','level') COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_teacher` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `testimonies` (
  `id_testimony` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_student` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rating` int NOT NULL,
  `content` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `job_portal_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
('0ad57273-10b7-468e-88eb-2f9f416c15b5', 'student6@example.com', 'Student 6 Name', '$2y$12$q7MQK5OELhWL9t2Cw5KqjermBGdJx1vloJ6vi4R4AmIDh3NUqC.9y', 'student', 1, NULL, NULL, '2025-07-01 00:49:11', '2025-07-01 00:49:11'),
...
('1cac6832-f582-4877-9f46-5c6fa0cb2c4a', 'student15@example.com', 'Student 15 Name', '$2y$12$asFnqHSaQRg5.n4Bv443/u3XKjC3Jhae8f58lzRGYS4GPILP.vWXS', 'student', 1, NULL, NULL, '2025-07-01 00:49:12', '2025-07-01 00:49:12'),
...
('52f74433-89b5-442a-852d-81e8c83c16fd', 'student1@example.com', 'Student 1 Name', '$2y$12$eknjhq9ifJMmNwVEBNzYLOmfWlkzH6Z4Q7FP7WlfS/3vdvV7DI7Y2', 'student', 1, NULL, NULL, '2025-07-01 00:49:09', '2025-07-01 00:49:09'),
