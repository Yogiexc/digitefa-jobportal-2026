  ...
  const handleSave = () => {
    form
      ...
      .then((values) => {
        ...
        Api.post(`/profile/company`, formData, {
          headers: {
          ...
          .then(() => {
            message.success(
              "Your Company Profile Successfully Created, please wait to validation by superadmin"
            );
            navigate("/request-profile");
          })
          .catch((error) => {
            console.error("Error:", error);
            message.error("Failed to create profile. Please check again.");
          });
      })
      .catch(() => {
        // error handling
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: "Please enter your company market name",
                },
              ]}
            >
...
export default FillProfileCompany;
