...
const UniversityList = () => {
  ...
  const columns = [
    ...
    { title: "University", dataIndex: "university_name", key: "university_name" },
    {
  ...
  const fetchData = (page, shouldFetchData) => {
    if (shouldFetchData) {
      setLoading(true);
      const url = `/universities/?page=${page}&pageSize=${pageSize}&sortBy=${sortBy}&sortOrder=${sortOrder}&search=${search}`;
      Api.get(url)
        .then((response) => {
