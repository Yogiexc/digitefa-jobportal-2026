...
const change_status_university_dto_1 = require("./dto/change-status-university.dto");
const jwt_auth_guard_1 = require("../auth/jwt-auth.guard");
let UniversitiesController = class UniversitiesController {
    constructor(universitiesService) {
        this.universitiesService = universitiesService;
    }
    findAllUniversityManagement(page, pageSize, search, sortBy, sortOrder) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'List all university (University Management)' }),
...
], UniversitiesController.prototype, "findAllUniversityManagement", null);
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiBearerAuth)('access-token'),
    (0, common_1.UseGuards)(new jwt_auth_guard_1.JwtAuthGuard(['superadmin'])),
    (0, swagger_1.ApiOperation)({ summary: 'List all university' }),
    (0, swagger_1.ApiQuery)({ name: 'page', required: false, type: Number, example: 1, description: 'Page number' }),
    (0, swagger_1.ApiQuery)({ name: 'pageSize', required: false, type: Number, example: 10, description: 'Number of items per page' }),
    (0, swagger_1.ApiQuery)({ name: 'search', required: false, type: String, example: '', description: 'Search term' }),
    (0, swagger_1.ApiQuery)({ name: 'sortBy', required: false, type: String, example: '', description: 'Field to sort by' }),
...
__decorate([
    (0, common_1.Get)('list'),
    (0, swagger_1.ApiOperation)({ summary: 'List all university for profile job seeker' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], UniversitiesController.prototype, "findAllList", null);
__decorate([
    (0, common_1.Get)(':university_id'),
    (0, swagger_1.ApiBearerAuth)('access-token'),
    (0, common_1.UseGuards)(new jwt_auth_guard_1.JwtAuthGuard(['superadmin'])),
    (0, swagger_1.ApiOperation)({ summary: 'Get a university' }),
    __param(0, (0, common_1.Param)('university_id')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)('access-token'),
    (0, common_1.UseGuards)(new jwt_auth_guard_1.JwtAuthGuard(['superadmin'])),
    (0, swagger_1.ApiOperation)({ summary: 'Change university status' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [change_status_university_dto_1.ChangeStatusUniversityDto]),
    __metadata("design:returntype", void 0)
], UniversitiesController.prototype, "changeStatus", null);
