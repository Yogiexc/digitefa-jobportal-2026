...
const change_status_company_dto_1 = require("./dto/change-status-company.dto");
...
], CompaniesController.prototype, "findAllCompanyManagement", null);
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiBearerAuth)('access-token'),
    (0, common_1.UseGuards)(new jwt_auth_guard_1.JwtAuthGuard(['superadmin'])),
...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)('access-token'),
    (0, common_1.UseGuards)(new jwt_auth_guard_1.JwtAuthGuard(['superadmin'])),
    (0, swagger_1.ApiOperation)({ summary: 'Change company status' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [change_status_company_dto_1.ChangeStatusCompanyDto]),
    __metadata("design:returntype", void 0)
], CompaniesController.prototype, "changeStatus", null);
