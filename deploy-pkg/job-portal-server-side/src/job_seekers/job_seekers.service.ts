...
export class JobSeekersService {
  ...
  async findOne(job_seeker_id: string) {
    ...
    try {
      ...
      const modifiedCertifications = existingJobSeekerDetail.certifications.map(certification => omit(certification, ['certification_id', 'job_seeker_detail_id', 'created_at', 'updated_at']));

      const modifiedLanguages = existingJobSeekerDetail.languages.map(language => omit(language, ['language_id', 'job_seeker_detail_id', 'created_at', 'updated_at']));
