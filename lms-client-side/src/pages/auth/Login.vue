                        ...
                        <form class="mx-3" @submit.prevent="loginStudent">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="password-wrapper">
                                    ...
                                    <div class="toggle-button password-toggle" @click="togglePassword" style="cursor: pointer;">
                                        <svg v-if="!isPasswordVisible" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
